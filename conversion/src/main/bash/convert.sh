...
convert_dev_guide() {
    ...
    java $MY_JAVA_OPTS -jar $SAXON_JAR -xi -s:$DEV_GUIDE_XML -o:$DEV_GUIDE_AD $D2A_XSLT &> $DEV_GUIDE_CONVERSION_LOG
...
convert_comp_ref() {
    ...
    java $MY_JAVA_OPTS -jar $SAXON_JAR -xi -s:$COMP_REF_XML -o:$COMP_REF_AD $D2A_XSLT &> $COMP_REF_CONVERSION_LOG

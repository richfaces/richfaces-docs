...
+
----
mvn archetype:generate -DarchetypeGroupId=org.richfaces.archetypes -DarchetypeArtifactId=richfaces-archetype-simpleapp -DarchetypeVersion=5.0.0.Alpha1 -DgroupId=org.docs.richfaces -DartifactId=new_project
----
+
...
====
The ability to prepare the project for Eclipse and export it using Maven is deprecated in RichFaces 5.0.0.Alpha1. The process does not support JBoss integration-specific features, such as JSF Facets.
====

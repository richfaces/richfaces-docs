...
Standard HTML controls can also be specifically defined in the CSS. Refer to the _$$/core/impl/src/main/resources/META-INF/resources/skinning_both.ecss$$_ file in the richfaces-ui.jarpackage for examples of specially-defined CSS classes with skin parameters for HTML controls.

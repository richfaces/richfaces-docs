...
+
If you want to test JSF from client's perspective with ability to access state of JSF internals, use [productname]#link:$$http://www.jboss.org/jsfunit$$[JBoss JSFUnit project]# (with Arquillian integration).
+

...
+
Create a new project based on the JSF 2 environment using the RichFaces 4 template. In [productname]#JBoss Tools#, select menu:File[New JSF Project] from the menu. Name the project, select [guilabel]#JSF 2# from the [guilabel]#JSF Environment# drop-down box, and click the [guibutton]#Finish# button to create the project.
+

...
[guilabel]#Create subscriberich:#:: true
[guilabel]#Delete subscriberich:#:: true
[guilabel]#Create durable subscriberich:#:: true
[guilabel]#Delete durable subscriberich:#:: true
...
There are several options to customize the style of the editorich:
...
Events can be handled either by registering a JavaScript event handler or by attaching JSF behaviorich:
...
Any file is accepted by rich:fileUpload component by default. There are three parameters available for limiting what can user upload to the serverich:
...
<rich:popupPanel id="popup" modal="false" autosized="true" resizeable="false">
    ...
    <f:facet name="controls">
        <h:graphicImage value="/pages/close.png" style="cursorich:pointer" onclick="#{rich:component('popup')}.hide()" />
    </f:facet>
    <p>
...
There are several attributes that can change default behaviorich:
...
<rich:jQuery selector="#customList trich:odd" timing="domready" query="addClass(odd)" />

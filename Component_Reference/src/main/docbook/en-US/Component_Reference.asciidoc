...
The <rich:editor>comes with a +lang+ attribute which allows you to change the localization of the editor. For language configuration options, refer to link:$$http://www.w3.org/TR/html4/struct/dirlang.html$$[http://www.w3.org/TR/html4/struct/dirlang.html].

...
image::images/figu-Component_Reference-richvalidator-Messages.png[Failed validation checks are reported using +&lt;rich:message&gt;+ components.]
...
image::images/figu-Component_Reference-richgraphValidator-Basic_usage.png[Failed validation checks are reported using +&lt;rich:message&gt;+ components.]
...
image::images/figu-Component_Reference-Tables_and_grids-richextendedDataTable_example.png[A data table made using the +&lt;rich:extendedDataTable&gt;+ component. It features horizontal and vertical scrolling and frozen columns.]

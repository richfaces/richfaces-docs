...
.[sgmltag]+<r:commandButton>+
image::images/figu-Component_Reference-commandButton-commandButton.png[]
...
.[sgmltag]+<r:commandLink>+
image::images/figu-Component_Reference-commandLink-commandLink.png[]
...
image::images/figu-Component_Reference-mediaOutput-mediaOutput_example_result.png[The generated image containing a random verification number.]
...
image::images/figu-Component_Reference-validator-Messages.png[Failed validation checks are reported using [sgmltag]+&lt;r:message&gt;+ components.]
...
image::images/figu-Component_Reference-graphValidator-Basic_usage.png[Failed validation checks are reported using [sgmltag]+&lt;r:message&gt;+ components.]
...
image::images/figu-Component_Reference-log-log_example.png[]
...
.[sgmltag]+<r:autocomplete>+
image::images/figu-Component_Reference-autocomplete-autocomplete.png[]
...
.[sgmltag]+<r:calendar>+
image::images/figu-Component_Reference-calendar-calendar.png[]
...
.[sgmltag]+<r:editor>+
image::images/figu-Component_Reference-editor-editor.png[width="400"]
...
image::images/figu-Component_Reference-editor-richfaces_skin.png[width="400"]
...
image::images/figu-Component_Reference-editor-distribution_skins.png[width="400"]
...
.[sgmltag]+<r:inplaceSelect>+
image::images/figu-Component_Reference-inplaceSelect-inplaceSelect.png[]
...
.[sgmltag]+<r:inputNumberSlider>+
image::images/figu-Component_Reference-inputNumberSlider-inputNumberSlider.png[]
...
.[sgmltag]+<r:inputNumberSpinner>+
image::images/figu-Component_Reference-inputNumberSpinner-inputNumberSpinner.png[]
...
.[sgmltag]+<r:select>+
image::images/figu-Component_Reference-select-select.png[]
...
.[sgmltag]+<r:select>+
image::images/figu-Component_Reference-orderingList-orderingList.png[]
...
.[sgmltag]+<r:select>+
image::images/figu-Component_Reference-pickList-pickList.png[]
...
.[sgmltag]+<r:panel>+
image::images/figu-Component_Reference-panel-panel.png[]
...
.Adding a header
image::images/figu-Component_Reference-panel-Adding_a_header.png[]
...
image::images/figu-Component_Reference-accordion-accordion.png[]
...
.[sgmltag]+<r:collapsiblePanel>+
image::images/figu-Component_Reference-collapsiblePanel-collapsiblePanel.png[]
...
.Header and controls
image::images/figu-Component_Reference-popupPanel-Header_and_controls.png[]
...
image::images/figu-Component_Reference-tabPanel-tabPanel_component.png[]
...
.[sgmltag]+<r:dataTable>+ example
image::images/figu-Component_Reference-dataTable_example.png[]
...
.Basic column example
image::images/figu-Component_Reference-column-Basic_column_example.png[]
...
.Column spanning example
image::images/figu-Component_Reference-column-Column_spanning_example.png[]
...
.Row spanning example
image::images/figu-Component_Reference-column-Row_spanning_example.png[]
...
.Complex headers using column groups
image::images/figu-Component_Reference-columnGroup-Complex_headers_using_column_groups.png[]
...
image::images/figu-Component_Reference-collapsibleSubTable-Basic_usage.png[A data table containing multiple collapsible sub-tables.]
...
image::images/figu-Component_Reference-Tables_and_grids-extendedDataTable_example.png[A data table made using the [sgmltag]+&lt;r:extendedDataTable&gt;+ component. It features horizontal and vertical scrolling and frozen columns.]
...
image::images/figu-Component_Reference-dataGrid-The_dataGrid_component.png[]
...
.[sgmltag]+<r:dataGrid>+ example
image::images/figu-Component_Reference-dataGrid-dataGrid_example.png[]
...
.Unordered list
image::images/figu-Component_Reference-list-Unordered_list.png[]
...
.Ordered list
image::images/figu-Component_Reference-list-Ordered_list.png[]
...
image::images/figu-Component_Reference-list-Data_definition_list.png[]
...
image::images/figu-Component_Reference-dataScroller-The_dataScroller_component.png[]
...
image::images/exam-Component_Reference-tree-Basic_usage.png[]
...
image::images/exam-Component_Reference-tree-nodeType_attribute.png[]
...
image::images/exam-Component_Reference-treeModelRecursiveAdaptor-Basic_usage.png[A hierarchical tree detailing a file system.]
...
.[sgmltag]+<r:dropDownMenu>+
image::images/figu-Component_Reference-dropDownMenu-dropDownMenu.png[]
...
.[sgmltag]+<r:contextMenu>+
image::images/figu-Component_Reference-contextMenu-contextMenu.png[]
...
image::images/figu-Component_Reference-panelMenu-panelMenu.png[A panel menu. The first menu group is collapsed. The second menu group is expanded; it contains menu items and a further menu group, which is currently selected and expanded. The third menu item is not a group and as such is not expandable.]
...
image::images/figu-Component_Reference-panelMenuGroup-Standard_icons.png[]
...
.[sgmltag]+<r:toolbar>+
image::images/figu-Component_Reference-toolbar-toolbar.png[]
...
* +disc+ shows a small circular disc to separate items: image:images/figu-Component_Reference-toolbar-disc.png[]
* +grid+ shows a grid pattern to separate items: image:images/figu-Component_Reference-toolbar-grid.png[]
* +line+ shows a vertical line to separate items: image:images/figu-Component_Reference-toolbar-line.png[]
* +square+ shows a small square to separate items: image:images/figu-Component_Reference-toolbar-square.png[]
...
image::images/figu-Component_Reference-toolbarGroup-toolbarGroup.png[A toolbar using icons. Two toolbar groups are located on the left-hand side of the toolbar and separated by a grid pattern. The third toolbar group is located to the right-hand side.]
...
.r:message component
image::images/figu-Component_Reference-message-message_component.png[]
...
image::images/figu-Component_Reference-messages-messages_component.png[]
...
.Messages in a block
image::images/figu-Component_Reference-messages-Messages_in_a_block.png[]
...
.Messages in a list
image::images/figu-Component_Reference-messages-Messages_in_a_list.png[]
...
.In-line messages
image::images/figu-Component_Reference-messages-In-line_messages.png[]
...
image::images/figu-Component_Reference-notifyMessages-notifyMessages.png[width="200"]
...
.[sgmltag]+<r:progressBar>+
image::images/figu-Component_Reference-progressBar-progressBar.png[]
...
.[sgmltag]+<r:tooltip>+
image::images/figu-Component_Reference-toolTip-toolTip.png[]
...
image::images/Component_Reference-jQuery-jQuery_example.png[A table highlighted in a "zebra" fashion, with every odd row colored.]
...
image::images/figu-Component_Reference-focus-Validation_aware.png[]
...
.[sgmltag]+<r:placeholder>+
image::images/figu-Component_Reference-placeholder-Input_components.png[]

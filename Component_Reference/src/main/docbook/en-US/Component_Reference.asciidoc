...
image::images/figu-Component_Reference-validator-Messages.png[Failed validation checks are reported using +&lt;r:message&gt;+ components.]
...
image::images/figu-Component_Reference-graphValidator-Basic_usage.png[Failed validation checks are reported using +&lt;r:message&gt;+ components.]
...
image::images/figu-Component_Reference-Tables_and_grids-extendedDataTable_example.png[A data table made using the +&lt;r:extendedDataTable&gt;+ component. It features horizontal and vertical scrolling and frozen columns.]

...
* The RICH_CALENDAR_APPLY_LABELstring is the label for the guibutton:[Apply] button.
* The RICH_CALENDAR_TODAY_LABELstring is the label for the guibutton:[Today] button.
* The RICH_CALENDAR_CLOSE_LABELstring is the label for the guibutton:[Close] button.
* The RICH_CALENDAR_OK_LABELstring is the label for the guibutton:[OK] button.
* The RICH_CALENDAR_CLEAN_LABELstring is the label for the guibutton:[Clean] button.
* The RICH_CALENDAR_CANCEL_LABELstring is the label for the guibutton:[Cancel] button.
